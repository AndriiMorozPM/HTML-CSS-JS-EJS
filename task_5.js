//програма виводить найновішу дату з масиву

/*для визначення найбільшої з дат, я конвертую string в тип date і порівнюю їх, і так на всій довжині 
масиву*/
...
console.log(`${mas1}: 'Найсвіжіша' дата - ${DateCompare(mas1)}`);
console.log(`${mas2}: 'Найсвіжіша' дата - ${DateCompare(mas2)}`);
console.log(`${mas3}: 'Найсвіжіша' дата - ${DateCompare(mas3)}`);
