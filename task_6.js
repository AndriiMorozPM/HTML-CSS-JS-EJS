//алгоритм бульбашкового сортування, сортує масив array за зростанням

/*В цьому алгоритмі порівнюються сусідні значення масиву і міняються таким чином, що більші стають справа,
а менші - зліва, і таким чином проходять по всьому масиві. Масив вважається посортованим, якщо за одне 
повне проходження по масиві не було поміняно ні одної пари.*/
